        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="#" class="dropdown-item">Effets </a></li>
              <li><a href="#" class="dropdown-item">Autre Effets</a></li>

              <li class="dropdown-divider"></li>

              <!-- Level two dropdown-->
              <li class="dropdown-submenu dropdown-hover">
                <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Cherche Effets</a>
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li class="dropdown-submenu">
                    ...
                    <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                      <li><a href="#" class="dropdown-item">3éme level</a></li>
                      <li><a href="#" class="dropdown-item">3éme level</a></li>
                    </ul>
                  </li>
                  <!-- End Level three -->
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm">demande si tu veux...</p>
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 heures aprés</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm">je prend votre message </p>
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Heures Aprés</p>
                </div>
              </div>
              <!-- Message End -->
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-users mr-2"></i> 8 amies require
