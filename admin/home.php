<h1 class=""> Votre Espace <!--<?php echo $_settings->info('name') ?>--> - Admin Envirenement</h1>
<style>
  #cover-image{
    width:calc(100%);
    height:50vh;
...
<div class="row">
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Totale Shop Type</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Totale Produits</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Total Panier Commands</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
