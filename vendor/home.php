<h1 class="">Bienvenue : <?php echo $_settings->info('name') ?> à Votre Espace</h1>
<style>
  #cover-image{
    width:calc(100%);
    height:50vh;
...
<div class="row">
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Tous les Categories</span>
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Tous les Produits</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Tous les Commandes</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
