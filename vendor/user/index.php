...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-primary shadow">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="shop_name" class="control-label">nom Shop</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_owner" class="control-label">Nom Vondeur</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_type_id" class="control-label">Type de shop</label>
					...
					<div class="row">
						...
						<small class="text-muted">Laissez le champ  vide si vous  souhaitez pas le mettre à jour</small>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="oldpassword" class="control-label">Entrer le mot de passe</label>
							<div class="input-group input-group-sm">
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-user">Modifier</button>
				</div>
			</div>
		</div>
	</div>
