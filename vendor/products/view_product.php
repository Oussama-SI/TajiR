...
?>
		<center>Uncnnu Categorie</center>
		<style>
...
<div class="container-fluid">
	...
	<div class="text-right">
		<button class="btn btn-default bg-gradient-dark btn-sm btn-flat" type="button" data-dismiss="modal"><i class="fa f-times"></i> Annuler</button>
	</div>
</div>
