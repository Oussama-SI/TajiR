...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" class="btn btn-flat btn-primary" id="create_new"><span class="fas fa-plus"></span>  Nouveau</a>
		</div>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
                                ...
                                <?php else: ?>
                                    <span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">désactive</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <a class="dropdown-item edit_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Modifie</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	...
	function delete_product($id){
		...
		$.ajax({
			...
			error:err=>{
				console.log(err)
				alert_toast("il ya un erreur.",'error');
				end_loader();
			},
