...
?>
		<center>Unconnu Shop-type</center>
		<style>
	...
	<form action="" id="product-form">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
						<label for="category_id" class="control-label">Catégories</label>
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/jpeg, image/jpg" <?= !isset($id) ? 'required' : '' ?>>
				</div>
