                ...
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">type de shope</label>
                        ...
                        <div class="row align-item-end">
                            <div class="col-8">
                                <a href="<?= base_url ?>">Retourner au Site</a>
                            </div>
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" class="btn btn-primary btn-block btn-flat">Créer compte</button>
                            </div>
                            <div class="col-12 text-center">
                            <a href="<?= base_url.'vendor/login.php' ?>">Déja un compte </a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
