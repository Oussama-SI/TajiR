...
<?php require_once('inc/header.php') ?>
  ...
  <div class="modal fade" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer rounded-0">
        <button type="button" class="btn btn-sm btn-flat btn-primary" id='submit' onclick="$('#uni_modal form').submit()">Souvgarde</button>
  ...
  <div class="modal fade" id="uni_modal_second" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer rounded-0">
        <button type="button" class="btn btn-sm btn-flat btn-primary" id='submit' onclick="$('#uni_modal_second form').submit()">Enregistre</button>
        <button type="button" class="btn btn-sm btn-flat btn-secondary" data-dismiss="modal">cConcel</button>
      </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="confirm_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer rounded-0">
        ...
        <button type="button" class="btn btn-sm btn-flat btn-secondary" data-dismiss="modal">Fermer</button>
      </div>
      </div>
    </div>
  </div>
