...
?>
		<center>Commande untrovable</center>
		<style>
...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">adresse Livraison</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($delivery_address) ? $delivery_address : '' ?></span></div>
        <div class="col-3 border bg-gradient-primary"><span class="">états</span></div>
        <div class="col-9 border"><span class="font-weight-bolder">
            ...
            ?>
            <?php if($status != 5): ?>
                <span class="pl-2"><a href="javascript:void(0)" id="update_status">Modifie Status</a></span>
            <?php endif; ?>
        </div>
    </div>
