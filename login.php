...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h1 text-decoration-none"><b>Login</b></a>
    </div>
    <div class="card-body">
      ...
      <form id="cclogin-frm" action="" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" autofocus placeholder="Identifiant">
        ...
        <div class="row align-item-end">
          ...
          <a href="<?= base_url.'./register.php' ?>">Créer Compte</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
