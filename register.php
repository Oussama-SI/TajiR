        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <a href="./register.php" class="h1"><b>Créer Compte</b></a>
                    </div>
                    <div class="card-body">
                    <p class="login-box-msg">Identifier pour Commancer</p>
                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <!--<div class="form-group col-md-4">
                                <label for="middlename" class="control-label">prenm</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="cpassword" class="control-label">Confirme Mot de pass</label>
                                <div class="input-group input-group-sm">
                        ...
                        <div class="row align-item-end">
                            ...
                            <a href="<?= base_url.'./login.php' ?>">déja un compte</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
