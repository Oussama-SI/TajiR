...
<div class="col-lg-12 py-5">
    <div class="contain-fluid">
        ...
        <h3 class="text-center"><b>Produits</b></h3>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 product-item">
                ...
                <div class="product-img-holder position-relative">
                    ...
                    <div class="card-body border-top border-gray">
                        ...
                        <div class="d-flex">
                            <div class="col-auto px-0"><small class="text-muted">Catégorie: </small></div>
        ...
        <div class="text-center">
            <a href="./?page=products" class="btn btn-large btn-primary rounded-pill col-lg-3 col-md-5 col-sm-12">Recherche des Produits</a>
        </div>
    </div>
</div>