<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b>Mes Commandes</b></h5>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="p1 text-center">Date Réservtion</th>
                        <th class="p1 text-center">Ref. Code</th>
                        <th class="p1 text-center">Total </th>
                        <th class="p1 text-center">étas</th>
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-1 align-middle text-center">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?= $row['id'] ?>" data-code="<?= $row['code'] ?>"><span class="fa fa-eye text-dark"></span> Vues</a>
                            </div>
                        </td>
                    </tr>
                    <?php endwhile; ?>
