...
?>
		<center>Commande Introuvable</center>
		<style>
		...
		<div class="text-right">
			<button class="btn btndefault bg-gradient-dark btn-flat" data-dismiss="modal"><i class="fa fa-times"></i> Fermer</button>
		</div>
		<?php
		exit;
		}
...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">Vondeur:</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($shop_name) ? $vcode.' - '.$shop_name : '' ?></span></div>
        <div class="col-3 border bg-gradient-primary"><span class="">Livraison Addresse</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($delivery_address) ? $delivery_address : '' ?></span></div>
        <div class="col-3 border bg-gradient-primary"><span class="">étas</span></div>
        ...
        <div class="col-12 border">
            <div class="d-flex align-items-center p-2">
                ...
                <div class="col-auto flex-shrink-1 flex-grow-1">
                    <h4><b><?= $prow['name'] ?></b></h4>
                    <div class="d-flex">
                        <div class="col-auto px-0"><small class="text-muted">Prix: </small></div>
                    ...
                    <div class="d-flex">
                        <div class="col-auto px-0"><small class="text-muted">Quantité: </small></div>
	...
	<div class="text-right">
        <?php if(isset($status) && $status == 0): ?>
		    <button class="btn btn-default bg-gradient-danger text-light btn-sm btn-flat" type="button" id="cancel_order">Fermer Commande</button>
        <?php endif; ?>
		<button class="btn btn-default bg-gradient-dark text-light btn-sm btn-flat" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Fermer</button>
	</div>
</div>
<script>
    $(function(){
