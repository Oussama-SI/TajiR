<div class="content py-3">
    <div class="card card-outline card-primary shadow rounded-0">
        <div class="card-header">
            <div class="h5 card-title">Vérifier</div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
                    <form action="" id="checkout-form">
                        <div class="form-group">
                            <label for="delivery_address" class="control-label"> Addresse Livraison</label>
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-flat btn-default btn-sm bg-navy">Comande Location</button>
                        </div>
                    </form>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="col-12 border">
                        <h2 class="text-center"><b>Bilan</b></h2>
                    </div>
                    <?php 
                    $gtotal = 0;
                    ...
                    <?php endwhile; ?>
                    <div class="col-12 border">
                        <b class="text-muted">Prix Total</b>
