...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow-0">
        <div class="card-header">
            <h5 class="card-title">Carte Liste</h5>
        </div>
        <div class="card-body">
            <div id="cart-list">
                <div class="row">
                ...
                ?>
                    <div class="col-12 border">
                        <span>Vondeur: <b><?= $vrow['code']. " - " . $vrow['shop_name'] ?></b></span>
                    </div>
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto flex-shrink-1 flex-grow-1">
                                        <button class="btn btn-flat btn-outline-danger btn-sm rem_item"  data-id="<?= $prow['id'] ?>"><i class="fa fa-times"></i> Supprimer</button>
                                    </div>
                                </div>
                            </div>
                ...
                <?php endwhile; ?>
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 h4 font-weight-bold text-right text-muted">Prix Total</div>
    ...
    <!--   <a href="./?page=orders/checkout" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-money-bill-wave"></i> Check</a>-->
    </div>
</div>
<script>
    $(function(){
