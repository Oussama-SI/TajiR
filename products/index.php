                    ...
                    <div class="list-group">
                        <div class="list-group-item list-group-item-action">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="cat_all" class="custom-control-label"> Tous</label>
                            </div>
                        </div>
                        <?php 
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-lg-8 col-md-10 col-sm-12">
                                <form action="" id="search-frm">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text">Recherche</span></div>
                        ...
                        <div class="row" id="product_list">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 product-item">
                                ...
                                <div class="product-img-holder position-relative">
                                    ...
                                    <div class="card-body border-top border-gray">
                                        ...
                                        <div class="d-flex">
                                            <div class="col-auto px-0"><spam class="text-muted">Categorie:  </spam></div>
                                        ...
                                        <div class="d-flex">
                                            <div class="col-auto px-0"><small class="text-muted">Price en DH : </small></div>
                            ...
                            <?php else: ?>
                                ...
                                Veuillez sélectionner au moins une catégorie de produits
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
