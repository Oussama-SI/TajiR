            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        ...
                        <div class="d-flex">
                            <div class="col-auto px-0"><small class="text-muted">Categorie: </small></div>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3 form-group">
                                <button class="btn btn-primary btn-flat" type="button" id="add_to_cart"><i class="fa fa-cart-plus"></i> Ajouter</button>
                            </div>
                        </div>
