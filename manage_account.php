			...
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="middlename" class="control-label">Nom</label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="lastname" class="control-label">Nom  du compte</label>
                    ...
                    <div class="row">
						...
						<small class="text-muted"><i>Laissez les champs de nouveau m-pass vide si vous ne veux pas le mettre à jour.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="oldpassword" class="control-label">Entrer Encien m-pass</label>
							<div class="input-group input-group-sm">
